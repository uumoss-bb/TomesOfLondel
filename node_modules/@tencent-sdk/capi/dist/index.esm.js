            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (isV3 || opts.isV3) {
                            _a = tencentSign(this.options.isPascalCase ? pascalCaseProps(restData) : restData, options), url_1 = _a.url, payload = _a.payload, authorization = _a.authorization, timestamp = _a.timestamp, host = _a.host;
                            reqOption = {
                                url: url_1,
                                method: 'POST',
                                responseType: 'json',
                            ...
                            _b = tencentSignV1(this.options.isPascalCase ? pascalCaseProps(reqData) : reqData, options), url_2 = _b.url, method = _b.method, payload = _b.payload;
                            reqOption = {
                                url: url_2,
                                method: method,
                                responseType: 'json',
